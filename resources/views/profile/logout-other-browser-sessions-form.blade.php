<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Visualiza y cierra tus sesiones activas en otros navegadores y dispositivos.') }}
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Si es necesario puedes cerrar sesión en otros dispositivos. Algunas de tus sesiones activas se enlistan a continuación. Si crees que tu cuenta se encuentra vulnerable, deberías además cambiar tu contraseña.') }}
        </div>
        ...
        <div class="flex items-center mt-5">
            <x-jet-button wire:click="confirmLogout" wire:loading.attr="disabled" style="color: greenyellow">
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Ingresa tu contraseña para confirmar esta acción.') }}
            ...
            <x-slot name="footer">
                ...
                <x-jet-button class="ml-2" style="color: greenyellow"
